...
public class Actividades extends javax.swing.JFrame {
   ...
   public int getInteger(String valor){
    ...
    public Actividades() {
        ...
        ResultSet rsTablaAnimales = util.Conexion.getSelect(selectAnimal,miConexion);
        ...
        ResultSet rsTablaCuidador = util.Conexion.getSelect(selectCuidador,miConexion);
        ...
        ResultSet rsTablaCuidados = util.Conexion.getSelect(selectCuidado,miConexion);
